...
curl --request POST \
  ...
  --header 'Authorization: Bearer bkua_dd775bfca4915f6fe13bedb096692655a66f9a00' \
  --header 'accept: */*' \
  ...
  --header 'x-csrf-token: jU9m8lZaJwC9mgXUblZou-jQvVztS2vVwRJF7MfT_eWkBGQt1W7Vf9x16hdw78hkTDexAQnT47vztmvGjvztcg' \
