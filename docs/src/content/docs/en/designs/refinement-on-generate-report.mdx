...
201 Created
{
    ...
    "boardMetricsReady": true | false | null <could be null if not required board metrics, default is null>, 
    "pipelineMetricsReady": true | false | null <could be null if not required pipeline metrics, default is null>, 
    "sourceControlMetricsReady": true | false | null <could be null if not required source control metrics, default is null>,
    "allMetricsReady": true | false <default is false>,
