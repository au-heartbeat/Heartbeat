...
class MetricsUtilTest {
	...
	void shouldGetRelatedPartMetrics() {
		...
		List<String> expectedBuildKiteMetrics = List.of(MetricEnum.PIPELINE_CHANGE_FAILURE_RATE.getValue(),
				MetricEnum.DEPLOYMENT_FREQUENCY.getValue(), MetricEnum.PIPELINE_MEAN_TIME_TO_RECOVERY.getValue());
