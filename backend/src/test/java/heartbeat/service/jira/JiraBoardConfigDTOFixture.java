...
public class JiraBoardConfigDTOFixture {
	...
	public static final long TIMESTAMP_1 = buildTimeStamp(1, 13, 4, 45, 50);

	public static final long TIMESTAMP_2 = buildTimeStamp(1, 24, 18, 32, 50);

	public static final long TIMESTAMP_3 = buildTimeStamp(1, 13, 4, 45, 50);

	public static final long TIMESTAMP_4 = buildTimeStamp(2, 5, 8, 19, 10);

	public static final long TIMESTAMP_5 = buildTimeStamp(2, 16, 22, 5, 10);

	public static final long TIMESTAMP_6 = buildTimeStamp(2, 20, 9, 25, 10);
	...
	public static final long TIMESTAMP_7 = buildTimeStamp(2, 18, 1, 52, 10);

	public static final long TIMESTAMP_8 = buildTimeStamp(2, 18, 16, 26, 10);

	public static final long TIMESTAMP_9 = buildTimeStamp(2, 19, 20, 13, 10);

	public static final long TIMESTAMP_10 = buildTimeStamp(1, 20, 1, 33, 10);

	public static final long TIMESTAMP_11 = buildTimeStamp(2, 20, 5, 33, 10);

	public static final long TIMESTAMP_12 = buildTimeStamp(2, 20, 6, 39, 10);
	...
	private static Long buildTimeStamp(int month, int day, int hour, int minute, int second) {
		return LocalDateTime.of(2023, month, day, hour, minute, second).toInstant(ZoneOffset.UTC).toEpochMilli();
	}
