...
//
// private static final String REQUEST_FILE_PATH =
// "src/test/java/heartbeat/controller/report/request.json";
//
// private static final String RESPONSE_FILE_PATH =
// "src/test/java/heartbeat/controller/report/reportResponse.json";
//
...
// @Test
// void shouldReturnEmptyWhenBoardMetricsIsEmpty() {
...
// verify(asyncReportRequestHandler).putReport(request.getBoardReportId(),
// eq(ReportResponse.builder().exportValidityTime(1800000L).build()));
// }
//
////
//// @Test
//// void shouldGenerateBoardReportAndSavedInCache() {
...
//// .jiraCardDTOList(Collections.emptyList())
//// .build());
//// when(jiraService.getJiraColumns(any(), any(),
// any())).thenReturn(JiraColumnResult.builder()
...
//// verify(asyncReportRequestHandler).putReport("",
// eq(ReportResponse.builder().velocity(velocity).exportValidityTime(1800000L).build()));
//// }
// }
//
////
...
//// DeploymentEnvironment mockDeployment =
// DeploymentEnvironmentBuilder.withDefault().build();
////
...
//// .build();
////
//// when(calculateDeploymentFrequency.calculate(any(), anyLong(),
// anyLong())).thenReturn(mockedDeploymentFrequency);
////
...
//// when(buildKiteService.countDeployTimes(any(), any(), any(), any())).thenReturn(
//// DeployTimesBuilder.withDefault().withPassed(List.of(DeployInfoBuilder.withDefault().build())).build());
//// when(gitHubService.fetchPipelinesLeadTime(any(), any(),
// any())).thenReturn(List.of(pipelineLeadTime));
...
////
//// @Test
//// void shouldGenerateCsvForPipelineWithPipelineMetricAndBuildInfoIsEmpty() throws
// IOException {
...
////
//// @Test
//// void shouldGenerateForBoardCsvWhenCallGenerateReporterWithBoardMetric() throws
// IOException {
//// JiraBoardSetting jiraBoardSetting = JiraBoardSetting.builder()
//// .treatFlagCardAsBlock(true)
...
////
//// @Test
//// void shouldDeleteExpireCsvWhenExportCsvWithCsvOutsideThirtyMinutes() throws
// IOException {
//// Files.createFile(mockPipelineCsvPath);
////
//// generateReporterService.deleteExpireCSV(System.currentTimeMillis(), new
// File("./csv/"));
////
...
////
//// @Test
//// void shouldNotDeleteOldCsvWhenExportCsvWithoutOldCsvInsideThirtyMinutes() throws
// IOException {
//// long currentTimeStamp = System.currentTimeMillis();
//// Path csvFilePath = Path.of(String.format("./csv/exportPipelineMetrics-%s.csv",
// currentTimeStamp));
//// Files.createFile(csvFilePath);
////
//// generateReporterService.deleteExpireCSV(currentTimeStamp - 800000, new
// File("./csv/"));
////
...
//// boolean generateReportIsOver =
// generateReporterService.checkGenerateReportIsDone(fileTimeStamp);
//// // then
...
//// // given
//// String fileTimeStamp = Long.toString(System.currentTimeMillis());
//// asyncReportRequestHandler.putReport("111111111",
// MetricCsvFixture.MOCK_METRIC_CSV_DATA_WITH_ONE_PIPELINE());
//// // when
//// boolean generateReportIsOver =
// generateReporterService.checkGenerateReportIsDone(fileTimeStamp);
//// // then
...
//// // when & then
//// GenerateReportException generateReportException =
...
//// assertEquals("Failed to get report due to report time expires",
...
// generateReporterService.getReportFromHandler(reportId);
//// // then
...
//// .thenReturn(new UnauthorizedException("Failed to get GitHub info_status: 401, reason:
//// PermissionDeny"));
////
//// ErrorInfo pipelineError =
...
//// assertEquals("Failed to get GitHub info_status: 401, reason: PermissionDeny",
//// pipelineError.getErrorMessage());
//// }
////
//// @Test
...
//// new PermissionDenyException("Failed to get GitHub info_status: 403, reason:
//// PermissionDeny"));
////
//// when(asyncExceptionHandler.get(reportId))
//// .thenReturn(new PermissionDenyException("Failed to get GitHub info_status: 403,
// reason:
//// PermissionDeny"));
//// ErrorInfo pipelineError =
//// generateReporterService.getReportErrorAndHandleAsyncException(timeStamp)
...
//// assertEquals("Failed to get GitHub info_status: 403, reason: PermissionDeny",
//// pipelineError.getErrorMessage());
//// }
////
//// @Test
...
////
//// when(asyncExceptionHandler.get(reportId))
//// .thenReturn(new NotFoundException("Failed to get GitHub info_status: 404, reason:
//// NotFound"));
//// ErrorInfo pipelineError =
//// generateReporterService.getReportErrorAndHandleAsyncException(timeStamp)
//// .getPipelineMetricsError();
...
//// assertEquals("Failed to get GitHub info_status: 404, reason: NotFound",
//// pipelineError.getErrorMessage());
//// }
////
//// @Test
...
////
//// when(asyncExceptionHandler.get(reportId))
//// .thenReturn(new GenerateReportException("Failed to get GitHub info_status: 500,
// reason:
//// GenerateReport"));
...
//// assertEquals("Failed to get GitHub info_status: 500, reason: GenerateReport",
...
//// new ServiceUnavailableException("Failed to get GitHub info_status: 503, reason:
//// ServiceUnavailable"));
//// BaseException exception = assertThrows(ServiceUnavailableException.class,
//// () -> generateReporterService.getReportErrorAndHandleAsyncException(timeStamp));
////
//// assertEquals(503, exception.getStatus());
//// assertEquals("Failed to get GitHub info_status: 503, reason: ServiceUnavailable",
//// exception.getMessage());
//// }
////
//// @Test
...
//// String reportId = IdUtil.getPipelineReportId(timeStamp);
////
//// when(asyncExceptionHandler.get(reportId)).thenReturn(new RequestFailedException(405,
...
//// assertEquals(
//// "Request failed with status statusCode 405, error: Request failed with status
//// statusCode 405, error: RequestFailedException",
//// exception.getMessage());
//// }
////
//// @Test
...
//// @Test
//// void
// shouldThrowBadRequestExceptionGivenMetricsContainCodeBaseWhenCodeBaseSettingIsNull() {
//// GenerateReportRequest request = GenerateReportRequest.builder()
//// .considerHoliday(false)
...
//// @Test
//// void
// shouldThrowBadRequestExceptionGivenMetricsContainBuildKiteWhenBuildKiteSettingIsNull()
// {
//// GenerateReportRequest request = GenerateReportRequest.builder()
//// .considerHoliday(false)
...
//// @Test
//// void
// shouldInitializeValueFalseGivenPreviousMapperIsNullWhenInitializeRelatedMetricsCompleted()
// {
...
//// @Test
//// void
// shouldInitializeValueFalseGivenPreviousValueExistWhenInitializeRelatedMetricsCompleted()
// {
//// String timeStamp = TIMESTAMP;
//// List<String> metrics = List.of(MetricEnum.CYCLE_TIME.getValue(),
// MetricEnum.DEPLOYMENT_FREQUENCY.getValue());
...
//// void
// shouldUpdateAndSetMetricsReadyNonnullTrueWhenMetricsExistAndPreviousMetricsReadyNotNull(List<String>
// metrics,
...
////
//// generateReporterService.updateMetricsDataCompletedInHandler(request.getCsvTimeStamp(),
// request.getMetrics());
////
//// verify(asyncReportRequestHandler,
// times(1)).putMetricsDataCompleted(request.getCsvTimeStamp(), expectedReady);
//// }
////
//// @Test
...
//// GenerateReportRequest request = GenerateReportRequest.builder()
//// .considerHoliday(false)
//// .metrics(List.of("velocity", "cycle time", "classification", "deployment frequency",
// "change failure rate",
...
//// .updateMetricsDataCompletedInHandler(request.getCsvTimeStamp(),
// request.getMetrics()));
////
//// }
////
...
////
//// ReportResponse composedResponse =
// generateReporterService.getComposedReportResponse(timeStamp, true);
////
...
//// .readValue(new File("src/test/java/heartbeat/controller/report/reportResponse.json"),
...
//// ReportResponse reportResponse = mapper.readValue(new File(RESPONSE_FILE_PATH),
// ReportResponse.class);
...
//// .initializeMetricsDataCompletedInHandler(reportRequest.getCsvTimeStamp(),
// reportRequest.getMetrics());
//// verify(spyGenerateReporterService, times(1)).saveReporterInHandler(
//// spyGenerateReporterService.generateReporter(reportRequest),
// reportRequest.getCsvTimeStamp());
//// verify(spyGenerateReporterService, times(1))
//// .updateMetricsDataCompletedInHandler(reportRequest.getCsvTimeStamp(),
// reportRequest.getMetrics());
//// }
////
//// @Test
//// void shouldPutExceptionInHandlerWhenCallGenerateBoardReportThrowException() throws
// IOException {
//// ObjectMapper mapper = new ObjectMapper();
//// GenerateReportRequest reportRequest = mapper.readValue(new File(REQUEST_FILE_PATH),
//// GenerateReportRequest.class);
...
// reportRequest.getMetrics());
//// verify(spyGenerateReporterService, times(1))
//// .saveReporterInHandler(spyGenerateReporterService.generateReporter(reportRequest),
// reportId);
//// verify(asyncExceptionHandler, times(1)).put(reportId, e);
//// }
////
//// @Test
//// void shouldPutExceptionInHandlerWhenCallGeneratePipelineReportThrowException() throws
// IOException {
//// ObjectMapper mapper = new ObjectMapper();
//// GenerateReportRequest reportRequest = mapper.readValue(new File(REQUEST_FILE_PATH),
//// GenerateReportRequest.class);
...
//// @Test
//// void
// shouldGeneratePipelineReportAndUpdatePipelineMetricsReadyWhenCallGeneratePipelineReport()
// throws IOException {
//// ObjectMapper mapper = new ObjectMapper();
//// GenerateReportRequest reportRequest = mapper.readValue(new File(REQUEST_FILE_PATH),
//// GenerateReportRequest.class);
...
//// verify(asyncExceptionHandler, times(1)).remove(reportId);
//// verify(spyGenerateReporterService,
// times(1)).initializeMetricsDataCompletedInHandler(any(), any());
//// verify(spyGenerateReporterService, times(1))
//// .saveReporterInHandler(spyGenerateReporterService.generateReporter(any()), reportId);
//// verify(spyGenerateReporterService,
// times(1)).updateMetricsDataCompletedInHandler(any(), any());
//// }
////
//// @Test
//// void
// shouldGenerateCodebaseReportAndUpdateCodebaseMetricsReadyWhenCallGenerateSourceControlReport()
//// throws IOException {
//// ObjectMapper mapper = new ObjectMapper();
//// GenerateReportRequest reportRequest = mapper.readValue(new File(REQUEST_FILE_PATH),
//// GenerateReportRequest.class);
...
//// .sourceControlMetricsCompleted(null)
//// .build()),
//// Arguments.of(List.of("deployment frequency", "change failure rate", "mean time to
//// recovery"),
//// MetricsDataCompleted.builder()
//// .boardMetricsCompleted(null)
//// .pipelineMetricsCompleted(false)
