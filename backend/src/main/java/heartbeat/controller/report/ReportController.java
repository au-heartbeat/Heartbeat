...
public class ReportController {
	...
	public InputStreamResource exportCSV(@PathVariable ReportType reportType, @PathVariable String filename) {
	...
	public ResponseEntity<CallbackResponse> generateReport(@PathVariable MetricType metricType,
