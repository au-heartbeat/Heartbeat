...
**Part 2:** Export the latest updated 50 non-done tickets in your current active board. And it will order by ticket status and then by last status change date(Image 3-16)
