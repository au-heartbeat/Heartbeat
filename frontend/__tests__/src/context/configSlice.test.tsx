...
describe('config reducer', () => {
  it('should be default value when init render config page', () => {
    ...
    expect(config.basic.projectName).toEqual('')
    expect(config.basic.calendarType).toEqual(REGULAR_CALENDAR)
    expect(config.basic.dateRange).toEqual({ startDate: '', endDate: '' })
  })
  ...
  it('should update project name when change project name input', () => {
    ...
    expect(config.basic.projectName).toEqual('mock project name')
  })
  ...
  it('should update calendar when change calendar types', () => {
    ...
    expect(config.basic.calendarType).toEqual(CHINA_CALENDAR)
  })
  ...
  it('should update date range when change date', () => {
    ...
    expect(config.basic.dateRange.startDate).toEqual(today)
    expect(config.basic.dateRange.endDate).toEqual('')
  })
  ...
  it('should update required data when change require data selections', () => {
    ...
    expect(config.basic.metrics).toEqual([VELOCITY])
  })
})
