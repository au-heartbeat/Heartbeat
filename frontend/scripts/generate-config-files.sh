...
sed -i -e "s/<E2E_WRONG_TOKEN_JIRA>/${E2E_TOKEN_JIRA}/g" "${import_file_name}"
sed -i -e "s/<E2E_WRONG_TOKEN_BUILD_KITE>/${E2E_TOKEN_BUILD_KITE}/g" "${import_file_name}"
sed -i -e "s/<E2E_WRONG_TOKEN_GITHUB>/${E2E_TOKEN_GITHUB}/g" "${import_file_name}"
echo "Successfully generate ${import_file_name}"
